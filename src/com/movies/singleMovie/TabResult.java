...
public class TabResult  
{
    ...
    public void addTabs()
	{
	    ...
	    tv1.setTextSize(TypedValue.COMPLEX_UNIT_PX,(int)tabResultInstance.getResources().getDimension(R.dimen.text_size2));
	    ...
	    tv3.setTextSize(TypedValue.COMPLEX_UNIT_PX,(int)tabResultInstance.getResources().getDimension(R.dimen.text_size2));
